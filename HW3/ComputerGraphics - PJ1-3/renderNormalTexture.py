...
class RenderWindow(pyglet.window.Window):
    ...
    #Difference : Add_Polygon
    def add_polygon(self, transform, indice, indexnormal, vertice, tex_coords):
        shape = CustomTextureGroup(transform, len(self.shapes), 'texturenormal')
        shape.indices = indice
        ...
        nmal = resource.texture('Free_rock/Free_rock_tex/Free_rock_Normal_OpenGL.jpg')
        shape.add_texture([base_color,mixed_ao, roughness, specular, nmal])
